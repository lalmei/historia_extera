...
The current engine writes schema 53. The current viewer reads schemas 28 through 53. There is
...
The viewer refuses exports below schema 21, above schema 53, or without a numeric schema
